...
import io.redis.jedis.RedisConfigUtils;
...
public class RedisConfigUtilsTest {
    ...
    protected static final Object[][] parserRedisServerListTestData() {
        ...
        // 未定义节点权重
                ...
                //
                { "192.168.6.189:6379:Shard-01,192.168.6.189:6380:Shard-02,192.168.6.189:6381:Shard-03", 300,
                        "[192.168.6.189:6379*1, 192.168.6.189:6380*1, 192.168.6.189:6381*1]" },// 节点配置信息之间不包含任何空格
                // 定义节点权重
